            ...
            <div class="hero-slider__slide"
                ...
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
                        <h2 class="headline headline--medium t-center"><?php the_title(68); ?></h2>
                        <p class="t-center">All students have free unlimited bus fare.</p>
                        <p class="t-center no-margin"><a href="<?php echo get_permalink(68); ?>"
            ...
            <div class="hero-slider__slide"
                ...
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
                        ...
                        <p class="t-center no-margin"><a href="<?php echo get_permalink(66); ?>"
                                class="btn btn--blue">Learn more</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="hero-slider__slide"
                ...
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
                        ...
                        <p class="t-center no-margin"><a href="<?php echo get_permalink(64); ?>"
                                class="btn btn--blue">Learn more</a></p>
                    </div>
                </div>
            </div>
                ...
                <div class="hero-slider__slide"
                    ...
                    <div class="hero-slider__interior container">
                        <div class="hero-slider__overlay">
                            ...
                            <p class="t-center no-margin"><a href="<?php the_permalink(); ?>" class="btn btn--blue">Learn
                                    more</a></p>
                        </div>
                    </div>
                </div>
